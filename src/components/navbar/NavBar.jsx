    ...
    <>
      <Top>
        {/* {history.location.pathname !== "/" && big && (
          <img src="images/VistaVoyage.svg" alt="" width="135px" />
        )} */}
        {!big && <img src="images/VistaVoyage.svg" alt="" width="135px" />}
        {med && (
          <First>
            {loginInfo.isAuth && (
              <img src="images/VistaVoyage.svg" alt="" width="120px" />
            )}
            <button
              className="firstBtns"
              style={{
      ...
      {history.location.pathname === "/" && (
        <Content>
          {!loginInfo.isAuth && tri && (
            <img src="images/VistaVoyage.svg" alt="" width="250px" />
          )}
          <div>
            {!loginInfo.isAuth ? (
              <h1>
