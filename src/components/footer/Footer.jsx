      ...
      <MainFoot>
        ...
        <Grid container className={classes.align}>
          <Grid item xs={12} md={9}>
            <h2 className={classes.whiteText}>
              VistaVoyage N.V., Kesselstraße 5 – 7, 40221 Düsseldorf, Germany
            </h2>
          </Grid>
        ...
        <Grid container>
          ...
          <Grid item sm={12} md={4}>
            <Bot1>
              ...
              <p>VistaVoyage Business Studio</p>
            </Bot1>
          </Grid>
          <Grid item sm={12} md={4}>
            <Bot1>
              <p>Help</p>
              <p>Learn how VistaVoyage works</p>
        ...
        <BotLogo>
          ...
          <p>Copyright 2024 VistaVoyage | All rights reserved.</p>
        </BotLogo>
      </MainFoot>
    </Div>
  );
